...
echo ""
echo "3. Run examples:"
echo "   python call_with_payload.py                    # Use default payload.json with Claude 3.7"
echo "   python call_with_payload.py payload-no-hallucination.json  # Use alternative payload"
echo "   python call_with_payload.py --model-id claude-3.5-sonnet   # Use Claude 3.5 Sonnet"
